...
import {ReachTextInput} from "../../../components/Admin/components/ReachTextInput";
import {TextField} from "../../../components/Admin/components/TextField";
import {ToolbarBlock, LinkButton, EditContainer, Button, EditToolbarBlock, DeleteButton} from "../../../components/Admin/TablesStyledBlocks";
...
export const NewsEdit = () => {
    ...
    async function updateNewsHandler() {
        if (validation.checkValidate()) {
            ...
            if (res) {
                navigate(`${AdminRouteNames.ADMIN_NEWS}/${id}`)
            }
        } else {
            setIsNotValid(true)
        }
